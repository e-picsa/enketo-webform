...
class AnalogScaleWidget extends RangeWidget {
  ...
  _renderLabels() {
    const fragment = document
      .createRange()
      .createContextualFragment('<div class="label-content widget"></div>');
  ...
  _updateLabels() {
    ...
    const maxLabel = document
      .createRange()
      .createContextualFragment(`<div class="max-label">${labels[1]}</div>`);
    ...
    const minLabel = document
      .createRange()
      .createContextualFragment(`<div class="min-label">${labels[2]}</div>`);
  ...
  get props() {
    ...
    props.showScale =
      props.appearances.includes("show-scale") && props.vertical && props.ticks;
